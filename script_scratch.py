...
plt.plot( 'x', 'y1', data=cvalues, marker='', markerfacecolor='blue', markersize=12, color='skyblue', linewidth=2)
plt.plot( 'x', 'y2', data=TrainingAccuracy, marker='', color='green', linewidth=2, label="TrainingAccuracy")
plt.plot( 'x', 'y3', data=TestAccuracy, marker='', color='olive', linewidth=2, linestyle='dashed', label="TestAccuracy")
plt.plot( 'x', 'y3', data=ValidationAccuracy, marker='', color='pink', linewidth=2, linestyle='dashed', label="ValidationAccuracy")
plt.legend()
plt.show()
